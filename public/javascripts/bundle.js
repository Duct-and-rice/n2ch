...
/***/ function(module, exports) {
	...
	riot.tag2('require', '', '', 'style scss', function(opts) {
	});
	riot.tag2('navbar', '<nav class="navbar navbar-default navbar-fixed-top"> <div class="container"><a class="navbar-brand">{opts.brand}</a> <ul class="nav navbar-nav"> <yield></yield> </ul> </div> </nav>', '.brand-logo{margin-left:10px;}', '', function(opts) {
	});
	riot.tag2('jumbotron', '<div class="jumbotron"> <h1>{opts.title}</h1> <p> <yield></yield> </p> </div>', '', '', function(opts) {
	});
